...
pub async fn create_sandbox(configuration: &configuration::Configuration, create_sandbox_request: models::CreateSandboxRequest) -> Result<models::SandboxResponse, Error<CreateSandboxError>> {
...
pub async fn delete_sandbox(configuration: &configuration::Configuration, public_id: &str) -> Result<models::DeleteSandboxResponse, Error<DeleteSandboxError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_public_id = public_id;

    let uri_str = format!("{}/v1/sandboxes/{public_id}", configuration.base_path, public_id=crate::apis::urlencode(p_path_public_id));
...
pub async fn get_sandbox(configuration: &configuration::Configuration, public_id: &str) -> Result<models::SandboxResponse, Error<GetSandboxError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_public_id = public_id;
...
pub async fn list_sandboxes(configuration: &configuration::Configuration, ) -> Result<models::ListSandboxesResponse, Error<ListSandboxesError>> {
...
pub async fn update_sandbox(configuration: &configuration::Configuration, public_id: &str, update_sandbox_request: models::UpdateSandboxRequest) -> Result<models::SandboxResponse, Error<UpdateSandboxError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_public_id = public_id;
