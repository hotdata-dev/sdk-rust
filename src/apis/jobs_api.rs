...
pub async fn list_jobs(configuration: &configuration::Configuration, job_type: Option<models::JobType>, status: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::ListJobsResponse, Error<ListJobsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
