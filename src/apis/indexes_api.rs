...
pub async fn create_dataset_index(configuration: &configuration::Configuration, dataset_id: &str, create_index_request: models::CreateIndexRequest) -> Result<models::IndexInfoResponse, Error<CreateDatasetIndexError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_dataset_id = dataset_id;
    let p_body_create_index_request = create_index_request;

    let uri_str = format!("{}/v1/datasets/{dataset_id}/indexes", configuration.base_path, dataset_id=crate::apis::urlencode(p_path_dataset_id));
...
pub async fn delete_dataset_index(configuration: &configuration::Configuration, dataset_id: &str, index_name: &str) -> Result<(), Error<DeleteDatasetIndexError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_dataset_id = dataset_id;
    let p_path_index_name = index_name;

    let uri_str = format!("{}/v1/datasets/{dataset_id}/indexes/{index_name}", configuration.base_path, dataset_id=crate::apis::urlencode(p_path_dataset_id), index_name=crate::apis::urlencode(p_path_index_name));
...
pub async fn list_dataset_indexes(configuration: &configuration::Configuration, dataset_id: &str) -> Result<models::ListIndexesResponse, Error<ListDatasetIndexesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_dataset_id = dataset_id;
