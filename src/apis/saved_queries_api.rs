...
pub async fn execute_saved_query(configuration: &configuration::Configuration, id: &str, x_database_id: &str, execute_saved_query_request: Option<models::ExecuteSavedQueryRequest>) -> Result<models::QueryResponse, Error<ExecuteSavedQueryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
