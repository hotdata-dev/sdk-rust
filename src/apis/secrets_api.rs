...
/// struct for typed errors of method [`create_secret_handler`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateSecretHandlerError {
    Status409(models::ApiErrorResponse),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`delete_secret_handler`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DeleteSecretHandlerError {
    Status404(models::ApiErrorResponse),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_secret_handler`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetSecretHandlerError {
    Status404(models::ApiErrorResponse),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`list_secrets_handler`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListSecretsHandlerError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`update_secret_handler`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UpdateSecretHandlerError {
    Status404(models::ApiErrorResponse),
    UnknownValue(serde_json::Value),
}
...
pub async fn create_secret_handler(configuration: &configuration::Configuration, create_secret_request: models::CreateSecretRequest) -> Result<models::CreateSecretResponse, Error<CreateSecretHandlerError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CreateSecretHandlerError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn delete_secret_handler(configuration: &configuration::Configuration, name: &str) -> Result<(), Error<DeleteSecretHandlerError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DeleteSecretHandlerError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Get metadata for a secret. The secret value is never returned.
pub async fn get_secret_handler(configuration: &configuration::Configuration, name: &str) -> Result<models::GetSecretResponse, Error<GetSecretHandlerError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetSecretHandlerError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// List all stored secrets. Only metadata (name, timestamps) is returned — secret values are never exposed.
pub async fn list_secrets_handler(configuration: &configuration::Configuration, ) -> Result<models::ListSecretsResponse, Error<ListSecretsHandlerError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ListSecretsHandlerError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn update_secret_handler(configuration: &configuration::Configuration, name: &str, update_secret_request: models::UpdateSecretRequest) -> Result<models::UpdateSecretResponse, Error<UpdateSecretHandlerError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UpdateSecretHandlerError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
