...
pub async fn add_managed_schema(configuration: &configuration::Configuration, connection_id: &str, add_managed_schema_request: models::AddManagedSchemaRequest) -> Result<models::ManagedSchemaResponse, Error<AddManagedSchemaError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_connection_id = connection_id;
    let p_body_add_managed_schema_request = add_managed_schema_request;

    let uri_str = format!("{}/v1/connections/{connection_id}/schemas", configuration.base_path, connection_id=crate::apis::urlencode(p_path_connection_id));
...
pub async fn add_managed_table(configuration: &configuration::Configuration, connection_id: &str, schema: &str, add_managed_table_request: models::AddManagedTableRequest) -> Result<models::ManagedTableResponse, Error<AddManagedTableError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_connection_id = connection_id;
    let p_path_schema = schema;
    let p_body_add_managed_table_request = add_managed_table_request;

    let uri_str = format!("{}/v1/connections/{connection_id}/schemas/{schema}/tables", configuration.base_path, connection_id=crate::apis::urlencode(p_path_connection_id), schema=crate::apis::urlencode(p_path_schema));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn check_connection_health(configuration: &configuration::Configuration, connection_id: &str) -> Result<models::ConnectionHealthResponse, Error<CheckConnectionHealthError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_connection_id = connection_id;
...
pub async fn create_connection(configuration: &configuration::Configuration, create_connection_request: models::CreateConnectionRequest) -> Result<models::CreateConnectionResponse, Error<CreateConnectionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn delete_managed_table(configuration: &configuration::Configuration, connection_id: &str, schema: &str, table: &str) -> Result<(), Error<DeleteManagedTableError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_connection_id = connection_id;
    let p_path_schema = schema;
    let p_path_table = table;

    let uri_str = format!("{}/v1/connections/{connection_id}/schemas/{schema}/tables/{table}", configuration.base_path, connection_id=crate::apis::urlencode(p_path_connection_id), schema=crate::apis::urlencode(p_path_schema), table=crate::apis::urlencode(p_path_table));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn get_connection(configuration: &configuration::Configuration, connection_id: &str) -> Result<models::GetConnectionResponse, Error<GetConnectionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_connection_id = connection_id;
...
pub async fn get_table_profile(configuration: &configuration::Configuration, connection_id: &str, schema: &str, table: &str) -> Result<models::TableProfileResponse, Error<GetTableProfileError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_connection_id = connection_id;
    let p_path_schema = schema;
    let p_path_table = table;
...
pub async fn list_connections(configuration: &configuration::Configuration, ) -> Result<models::ListConnectionsResponse, Error<ListConnectionsError>> {
...
pub async fn load_managed_table(configuration: &configuration::Configuration, connection_id: &str, schema: &str, table: &str, load_managed_table_request: models::LoadManagedTableRequest) -> Result<models::LoadManagedTableResponse, Error<LoadManagedTableError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_connection_id = connection_id;
    let p_path_schema = schema;
    let p_path_table = table;
    ...
    let uri_str = format!("{}/v1/connections/{connection_id}/schemas/{schema}/tables/{table}/loads", configuration.base_path, connection_id=crate::apis::urlencode(p_path_connection_id), schema=crate::apis::urlencode(p_path_schema), table=crate::apis::urlencode(p_path_table));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn purge_connection_cache(configuration: &configuration::Configuration, connection_id: &str) -> Result<(), Error<PurgeConnectionCacheError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_connection_id = connection_id;
...
pub async fn purge_table_cache(configuration: &configuration::Configuration, connection_id: &str, schema: &str, table: &str) -> Result<(), Error<PurgeTableCacheError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_connection_id = connection_id;
    let p_path_schema = schema;
    let p_path_table = table;
