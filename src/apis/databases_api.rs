...
pub async fn add_database_schema(configuration: &configuration::Configuration, database_id: &str, add_managed_schema_request: models::AddManagedSchemaRequest) -> Result<models::ManagedSchemaResponse, Error<AddDatabaseSchemaError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_id = database_id;
    let p_body_add_managed_schema_request = add_managed_schema_request;

    let uri_str = format!("{}/v1/databases/{database_id}/schemas", configuration.base_path, database_id=crate::apis::urlencode(p_path_database_id));
...
pub async fn add_database_table(configuration: &configuration::Configuration, database_id: &str, schema: &str, add_managed_table_request: models::AddManagedTableRequest) -> Result<models::ManagedTableResponse, Error<AddDatabaseTableError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_id = database_id;
    let p_path_schema = schema;
    let p_body_add_managed_table_request = add_managed_table_request;

    let uri_str = format!("{}/v1/databases/{database_id}/schemas/{schema}/tables", configuration.base_path, database_id=crate::apis::urlencode(p_path_database_id), schema=crate::apis::urlencode(p_path_schema));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn attach_database_catalog(configuration: &configuration::Configuration, database_id: &str, attach_database_catalog_request: models::AttachDatabaseCatalogRequest) -> Result<(), Error<AttachDatabaseCatalogError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_id = database_id;
    let p_body_attach_database_catalog_request = attach_database_catalog_request;

    let uri_str = format!("{}/v1/databases/{database_id}/catalogs", configuration.base_path, database_id=crate::apis::urlencode(p_path_database_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn create_database(configuration: &configuration::Configuration, create_database_request: models::CreateDatabaseRequest) -> Result<models::CreateDatabaseResponse, Error<CreateDatabaseError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn delete_database(configuration: &configuration::Configuration, database_id: &str) -> Result<(), Error<DeleteDatabaseError>> {
    ...
    let uri_str = format!("{}/v1/databases/{database_id}", configuration.base_path, database_id=crate::apis::urlencode(p_path_database_id));
...
pub async fn detach_database_catalog(configuration: &configuration::Configuration, database_id: &str, connection_id: &str) -> Result<(), Error<DetachDatabaseCatalogError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_id = database_id;
    let p_path_connection_id = connection_id;

    let uri_str = format!("{}/v1/databases/{database_id}/catalogs/{connection_id}", configuration.base_path, database_id=crate::apis::urlencode(p_path_database_id), connection_id=crate::apis::urlencode(p_path_connection_id));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn get_database(configuration: &configuration::Configuration, database_id: &str) -> Result<models::DatabaseDetailResponse, Error<GetDatabaseError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_id = database_id;
...
pub async fn list_databases(configuration: &configuration::Configuration, ) -> Result<models::ListDatabasesResponse, Error<ListDatabasesError>> {
