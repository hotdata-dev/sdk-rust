...
pub async fn information_schema(configuration: &configuration::Configuration, connection_id: Option<&str>, schema: Option<&str>, table: Option<&str>, include_columns: Option<bool>, limit: Option<i32>, cursor: Option<&str>) -> Result<models::InformationSchemaResponse, Error<InformationSchemaError>> {
