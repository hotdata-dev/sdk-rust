...
pub struct CreateConnectionRequest {
    ...
    pub secret_id: Option<Option<serde_json::Value>>,
    ...
    pub secret_name: Option<Option<serde_json::Value>>,
...
impl CreateConnectionRequest {
    ...
    pub fn new(config: Option<serde_json::Value>, name: String, source_type: String) -> CreateConnectionRequest {
